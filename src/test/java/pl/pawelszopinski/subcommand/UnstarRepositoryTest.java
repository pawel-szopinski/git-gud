...
class UnstarRepositoryTest {
    ...
    void testStarRepoSuccess() {
        String responseBody = "You are no longer starring this repository.";
        ...
        mockServer.when(request()
                ...
                .respond(response().withStatusCode(204).withBody(responseBody));

        //when
        CommandLine cmd = new CommandLine(new UnstarRepository());
        ...
        assertEquals(responseBody, StringUtils.chomp(sw.toString()));
    }
